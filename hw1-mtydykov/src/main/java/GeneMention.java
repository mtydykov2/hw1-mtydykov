...
public class GeneMention extends Annotation {
  ...
  public String getSentenceId() {
    ...
    return jcasType.ll_cas.ll_getStringValue(addr,
            ((GeneMention_Type) jcasType).casFeatCode_sentenceId);
  }
  ...
  public void setSentenceId(String v) {
    if (GeneMention_Type.featOkTst && ((GeneMention_Type) jcasType).casFeat_sentenceId == null)
      jcasType.jcas.throwFeatMissing("sentenceId", "GeneMention");
    jcasType.ll_cas
            .ll_setStringValue(addr, ((GeneMention_Type) jcasType).casFeatCode_sentenceId, v);
  }
  ...
  public int getMentionBegin() {
    ...
    return jcasType.ll_cas.ll_getIntValue(addr,
            ((GeneMention_Type) jcasType).casFeatCode_mentionBegin);
  }
  ...
  public int getMentionEnd() {
    ...
    return jcasType.ll_cas.ll_getIntValue(addr,
            ((GeneMention_Type) jcasType).casFeatCode_mentionEnd);
  }
  ...
  public String getMentionText() {
    ...
    return jcasType.ll_cas.ll_getStringValue(addr,
            ((GeneMention_Type) jcasType).casFeatCode_mentionText);
  }
  ...
  public void setMentionText(String v) {
    if (GeneMention_Type.featOkTst && ((GeneMention_Type) jcasType).casFeat_mentionText == null)
      jcasType.jcas.throwFeatMissing("mentionText", "GeneMention");
    jcasType.ll_cas.ll_setStringValue(addr, ((GeneMention_Type) jcasType).casFeatCode_mentionText,
            v);
  }
}
