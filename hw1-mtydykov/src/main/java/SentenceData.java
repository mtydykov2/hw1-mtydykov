...
public class SentenceData extends Annotation {
  ...
  public String getSentenceText() {
    ...
    return jcasType.ll_cas.ll_getStringValue(addr,
            ((SentenceData_Type) jcasType).casFeatCode_sentenceText);
  }
  ...
  public void setSentenceText(String v) {
    ...
    jcasType.ll_cas.ll_setStringValue(addr,
            ((SentenceData_Type) jcasType).casFeatCode_sentenceText, v);
  }
  ...
  public String getSentenceId() {
    ...
    return jcasType.ll_cas.ll_getStringValue(addr,
            ((SentenceData_Type) jcasType).casFeatCode_sentenceId);
  }
  ...
  public void setSentenceId(String v) {
    if (SentenceData_Type.featOkTst && ((SentenceData_Type) jcasType).casFeat_sentenceId == null)
      jcasType.jcas.throwFeatMissing("sentenceId", "SentenceData");
    jcasType.ll_cas.ll_setStringValue(addr, ((SentenceData_Type) jcasType).casFeatCode_sentenceId,
            v);
  }
}
