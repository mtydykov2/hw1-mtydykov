...
public class GoldMention extends Annotation {
  ...
  public String getSentenceId() {
    ...
    return jcasType.ll_cas.ll_getStringValue(addr,
            ((GoldMention_Type) jcasType).casFeatCode_sentenceId);
  }
  ...
  public void setSentenceId(String v) {
    if (GoldMention_Type.featOkTst && ((GoldMention_Type) jcasType).casFeat_sentenceId == null)
      jcasType.jcas.throwFeatMissing("sentenceId", "GoldMention");
    jcasType.ll_cas
            .ll_setStringValue(addr, ((GoldMention_Type) jcasType).casFeatCode_sentenceId, v);
  }
  ...
  public int getMentionBegin() {
    ...
    return jcasType.ll_cas.ll_getIntValue(addr,
            ((GoldMention_Type) jcasType).casFeatCode_mentionBegin);
  }
  ...
  public int getMentionEnd() {
    ...
    return jcasType.ll_cas.ll_getIntValue(addr,
            ((GoldMention_Type) jcasType).casFeatCode_mentionEnd);
  }
  ...
  public String getMentionText() {
    ...
    return jcasType.ll_cas.ll_getStringValue(addr,
            ((GoldMention_Type) jcasType).casFeatCode_mentionText);
  }
  ...
  public void setMentionText(String v) {
    if (GoldMention_Type.featOkTst && ((GoldMention_Type) jcasType).casFeat_mentionText == null)
      jcasType.jcas.throwFeatMissing("mentionText", "GoldMention");
    jcasType.ll_cas.ll_setStringValue(addr, ((GoldMention_Type) jcasType).casFeatCode_mentionText,
            v);
  }
}
