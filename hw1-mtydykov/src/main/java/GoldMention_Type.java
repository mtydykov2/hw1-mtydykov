...
public class GoldMention_Type extends Annotation_Type {
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  		     ...
  		     return fs;
        } else return new GoldMention(addr, GoldMention_Type.this);
  	  }
    };
  /** @generated */
  ...
  public GoldMention_Type(JCas jcas, Type casType) {
    ...
    casFeat_mentionBegin = jcas.getRequiredFeatureDE(casType, "mentionBegin", "uima.cas.Integer", featOkTst);
    casFeatCode_mentionBegin  = (null == casFeat_mentionBegin) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_mentionBegin).getCode();

 
    casFeat_mentionEnd = jcas.getRequiredFeatureDE(casType, "mentionEnd", "uima.cas.Integer", featOkTst);
    casFeatCode_mentionEnd  = (null == casFeat_mentionEnd) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_mentionEnd).getCode();
