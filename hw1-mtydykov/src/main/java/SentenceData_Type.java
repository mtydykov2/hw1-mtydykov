...
public class SentenceData_Type extends Annotation_Type {
  ...
  private final FSGenerator fsGenerator = new FSGenerator() {
    public FeatureStructure createFS(int addr, CASImpl cas) {
      if (SentenceData_Type.this.useExistingInstance) {
        ...
        return new SentenceData(addr, SentenceData_Type.this);
    }
  };
  ...
  public SentenceData_Type(JCas jcas, Type casType) {
    ...
    casFeat_sentenceText = jcas.getRequiredFeatureDE(casType, "sentenceText", "uima.cas.String",
            featOkTst);
    casFeatCode_sentenceText = (null == casFeat_sentenceText) ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_sentenceText).getCode();
